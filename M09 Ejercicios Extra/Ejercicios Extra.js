...
function numberOfCharacters(string) {
   ...
   // Tu código: .split("")  = convertir array   .join("")= convertir en string
   const obj = {}
...
function asAmirror(frase) {
   ...
   // Tu código:
   let nuevafrase = frase.split(" ") //transformar la frase a array
   let array = [];
   nuevafrase.forEach(element => {
      array.push (element.split("").reverse().join("")); //dar vuelta el array
   });
   let string = array.join(" "); //volver a convertir en string
return string
}
